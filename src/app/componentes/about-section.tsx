    ...
    return (
        ...
        >
            <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-y-12 lg:grid-rows-[auto-1fr]">
                ...
                <div className="lg:order-first lg:row-span-2 text-center md:text-start xs:ml-[-30%] md:ml-[-12%]">
                    ...
                    <div className="mt-6 flex justify-center md:justify-start gap-6 sm:ml-[-5%] md:ml-[7%]">
