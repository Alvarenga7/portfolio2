    ...
    return (
        ...
        >
            <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-y-12 lg:grid-rows-[auto-1fr]">
                ...
                <div className="lg:order-first lg:row-span-2 text-center md:text-start ml-[10%] sm:ml-[-25%] ">
                    <h1 className="font-heading text-3xl md:text-4xl lg:text-5xl lg:ml-[3%]  ">@alvarenga</h1>
                    <p className="mt-6 text-base text-muted-foreground sm:ml-[5%]   ">Olá, Sou Henrique Alvarenga Hastenreiter, tenho  17 anos e sou apaixonado por tecnologia.
                    ...
                    <div className="mt-6 flex justify-center md:justify-start gap-6 lg:ml-[5%] ">
