                ...
                <div className="lg:pl-20 flex justify-center">
                    <div className="max-w-xs px-2.5 lg:max-w-none">
                        <Image
                            ...
                            quality='95'
                            priority={true}
                            className="aspect-square rotate-3 rounded-lg bg-zinc-100 dark:bg-zinc-800 object-cover sm:ml-[-35%] lg:ml-[25%] mt-[-7%]"
                        />
                    </div>
                </div>
                <div className="lg:order-first lg:row-span-2 text-center md:text-start ml-[15%]">
                    <h1 className="font-heading text-3xl md:text-4xl lg:text-5xl sm:ml-[-25%] ">@alvarenga</h1>
                    <p className="mt-6 text-base text-muted-foreground sm:ml-[-25%] ">Olá, Sou Henrique Alvarenga Hastenreiter, tenho  17 anos e sou apaixonado por tecnologia.
                    ...
                    <div className="mt-6 flex justify-center md:justify-start gap-6 sm:ml-[-25%] ">
